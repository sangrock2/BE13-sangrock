...
// Spring Security의 경우, 찾는 Bean 이름은 springSecurityFilterChain이고, 이 Bean의 정체게 바로 FilterChainProxy이다.
...
// 5. 헤더가 없거나 인즈에 실패하면 BasicAuthenticationEntiryPoint가 401 Unauthorized 와 WW-Authentictate: Basic 헤더를 응답한다 (다시 1번 상황으로)
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // BasicAuthenticationFilter가 필터 체인에 등록이 된다.
        // 즉 "이제부터 AUthorization: Basic 헤더를 읽어서 인증을 처리하겠다는 선언이다.
